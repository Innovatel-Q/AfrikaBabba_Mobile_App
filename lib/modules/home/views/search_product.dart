                        ...
                        return ListView(
                          children: [
                            ...
                            Wrap(
                              ...
                              children: [
                                _buildModernTag("Industriel", Colors.blue[100]!),
                                _buildModernTag("Matières premières", Colors.purple[100]!),
                                _buildModernTag("Sport & Improvement", Colors.pink[100]!),
                                _buildModernTag("Fashion & Beauty", Colors.orange[100]!),
                                _buildModernTag("Home Décor", Colors.green[100]!),
                                _buildModernTag("Commercial Equipment & Machine", Colors.teal[100]!),
                              ],
                            ),
                            SizedBox(height: screenHeight * 0.03),
